...
async def help(client, message):
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(" join now ", url="https://t.me/MovieCloudAI"),
                    InlineKeyboardButton("About Me", callback_data="about_data")
                ],
                [
                    InlineKeyboardButton("BOT Channel", url="https://t.me/MovieCloudAI"),
                    InlineKeyboardButton("Support Group", url="https://t.me/MovieCloudAI")
                ]
            ]
        ),
        reply_to_message_id=message.message_id
            ...
            [
                [
                    InlineKeyboardButton(
                        "SOURCE CODE", url="https://github.com/jamshimfinu/Unlimited-Filter-Max-Bot")
                ],
                [
